...
`◇───────────────◇️ ` 
    """
JOIN_ASAP = f" **🚫 Access Denied**\n\n You Must Join [My Channel](https://t.me/mahbotupdate)To Use Me. So, Please Join it & Try Again." 
FSUBB = InlineKeyboardMarkup( 
           [[ 
               InlineKeyboardButton(text="My Channel ", url=f"https://t.me/mahbotupdate") 
           ]] 
)
...
async def logo(client, message):      
 try:
        await message._client.get_chat_member(int("-1001666755642"), message.from_user.id)
 ...
 try:
    ...
    await client.send_message(message.chat.id, f'Error, Report @Call_me_futurepilot, {e}')
    await m.delete()
...
__HELP__ = """
**Create Beautiful logos for your profile pictures from Hijab Queen.**
...
[More Info Click Here](https://t.me/mahsoombotupdate)

Logo Maker is Powered by @Call_me_futurepilot
 """
