...
◇️ ━━━━━━━━━ ◇️
👨‍💻 **Generated By**: [Hijab Queen](https://t.me/hijabqueen_bot)
🙋‍♂️ **Requestor** : {}
⚡️ **Powered By**   : [MAHSOOM](https://t.me/Call_me_futurepilot)
◇️ ━━━━━━━━━ ◇️
**©2022** [Hijab Queen](http://t.me/hijabqueen_bot) **Bot All Rights Reserved**
"""
...
⚡️ **Powered By**   : [MAHSOOM](https://t.me/Call_me_futurepilot)
◇───────────────◇️
**©2022** [Hijab Queen](https://t.me/hijabqueen_bot) **Bot All Rights Reserved**
"""

CHANNEL = -1001633313780

@app.on_message(filters.command("picme") & filters.user([2078133195,2135475168]))
async def sendthepicme(_, message):
    await app.send_photo(chat_id=int(CHANNEL),photo="https://telegra.ph/file/978d831cb56f6e4befca8.jpg",caption=picmetxt.format(message.from_user.mention), reply_markup=picmebtns)
...
""", show_alert=True)
    ...
    if mode == "pm":
        try:
            ...
            await query.answer("Please Frist Start This 👉 @hijabqueen_bot")
            print(str(e))
            if os.path.exists(photo):os.remove(photo)     
