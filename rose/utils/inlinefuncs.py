...
from rose import (BOT_USERNAME, MESSAGE_DUMP_CHAT, SUDOERS, USERBOT_ID,
                 USERBOT_NAME, USERBOT_USERNAME, app, app2, arq)
from rose.core.keyboard import ikb
from rose.core.tasks import _get_tasks_text, all_tasks, rm_task
from rose.core.types import InlineQueryResultCachedDocument
from rose.modules.info import get_chat_info, get_user_info
from rose.utils.functions import test_speedtest
...
async def inline_help_func(__HELP__):
    ...
    answerss = [
        InlineQueryResultArticle(
            ...
            description="Most Advance Inline Help Menu Here",
...
async def logo_func(answers, text):
